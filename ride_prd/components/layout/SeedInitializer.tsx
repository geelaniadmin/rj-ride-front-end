...
const SEED_VEHICLES = [
  ...
  { id: "VH3", tenantId: "T1", ownerVendorId: "V1", ownership: "OWN" as const, vehicleTypeId: "VT3", make: "Force", model: "Tempo Traveller", year: 2023, registrationNo: "KA05EF9012", seatingCapacity: 12, ac: true, fuelType: "DIESEL" as const, traccarDeviceId: "TRA-003", documents: [{ kind: "REGISTRATION" as const, number: "KA05EF9012", expiry: "2027-08-20" }], active: true },
  ...
  { id: "VH5", tenantId: "T1", ownerVendorId: "V2", ownership: "SUB_VENDOR" as const, vehicleTypeId: "VT2", make: "Toyota", model: "Fortuner", year: 2024, registrationNo: "KA05IJ7890", seatingCapacity: 6, ac: true, fuelType: "DIESEL" as const, traccarDeviceId: "TRA-005", documents: [], active: true },
];
